...
const News = ({ title, date, text }: NewsProps) => {
    return (
        <div className="pt-[347px] px-[271.5px] md:flex flex-col hidden items-center bg-[#F2F2F2]">
            <div className="flex flex-col lg:flex-row justify-between items-end w-[81.75%] min-w-[480px] ">
                <h1 className="font-rajdhani text-[#0A0A0A] leading-[61.25px] text-5xl font-bold">
                    {title}
                </h1>
